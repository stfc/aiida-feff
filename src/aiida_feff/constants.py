...
Units throughout ``aiida-feff`` are Ångström and electron-volt.  No Bohr or
Rydberg conversion exists anywhere; if one is ever needed it belongs here.
...
#: This is IFEFFIT's and larch's ``ETOK``; derived here rather than hard-coded
#: so the value tracks CODATA through scipy.
