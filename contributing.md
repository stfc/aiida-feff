...
This document outlies the best practices for contributing to the aiida-feff project. These must be 
...
``` sh 
$ git clone -b issueXYZ --single-branch git@github.com:username/aiida-feff.git 
```
...
$ git clone git@github.com:username/aiida-feff.git 
